...
collectCoin = () => {
  ...
  buyWeaponAPI = (i) => {
    ...
    if (weapon !== 101 && weapon > newWeapon.id) return
  ...
  buyShieldAPI = (i) => {
    ...
    if (shield !== 103 && shield > newShield.id) return
  ...
  buyHeadAPI = (i) => {
    ...
    if (head !== 100 && head > newHead.id) return
  ...
  buyChestAPI = (i) => {
    ...
    if (chest !== 102 && chest > newChest.id) return
  ...
  buyLegsAPI = (i) => {
    ...
    if (legs !== 104 && legs > newLegs.id) return
  ...
  buyFeetAPI = (i) => {
    ...
    if (feet !== 105 && feet > newFeet.id) return
